...
for iChan = chan_to_view
    ...
    data.Channels{iChan,1}.data = data.Channels{iChan,1}.data(1:.25*round(length(data.Channels{iChan,1}.data)));
    data.Channels{iChan,1}.tvec= data.Channels{iChan,1}.tvec(1:.25*round(length(data.Channels{iChan,1}.tvec)));
