function h = overplot(cfg_in,varargin)
%OVERPLOT Add iv and tsd to existing figure.
...
%
%   OVERPLOT can be called alone or used to quickly plot multiple TSDs or
%   IVs in an existing figure, such as a rasterplot.
%
%   h = OVERPLOT(cfg,varargin);
%
%   h = OVERPLOT(cfg,TSD1,TSD2,IV1,TSD3);
...
%                        overplot is called inside of another function
