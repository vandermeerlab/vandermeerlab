        ...
        for iC = 1:length(fsi_labels)
            ...
            if ~od.fsi_res.near_spec{iC}.flag_tooFewSpikes && ...
               ...
               ~od.fsi_res.near_p2_spec{iC}.flag_no_subsampling
                ...
                flag_leg = true;
                this_legend{length(this_legend)+1} = sprintf('All Trials: %d spikes',od.fsi_res.near_spec{iC}.spk_count);
                plot(od.fsi_res.near_spec{iC}.sta_time, od.fsi_res.near_p1_spec{iC}.sta_vals, 'Color', 'magenta');
                this_legend{length(this_legend)+1} = sprintf('P1 Trials: %d spikes',od.fsi_res.near_p1_spec{iC}.spk_count);
                plot(od.fsi_res.near_spec{iC}.sta_time, od.fsi_res.near_p2_spec{iC}.sta_vals, 'Color', 'black');
                ...
                if all_sts_peaks_in_lg && all_ppc_peaks_in_lg && ...
                    ...
                    this_legend{length(this_legend)+1} = sprintf ...
                       ('All Trials lg peak: %2.2f Hz, hg peak: %2.2f Hz ',...
                       near_lg_sts_pk, near_hg_sts_pk);
                    plot(od.fsi_res.near_p1_spec{iC}.freqs, od.fsi_res.near_p1_spec{iC}.subsampled_sts, 'magenta');
                    ...
                    plot(od.fsi_res.near_p2_spec{iC}.freqs, od.fsi_res.near_p2_spec{iC}.subsampled_sts, 'black');
                    ...
                    this_legend{length(this_legend)+1} = sprintf ...
                       ('All Trials lg peak: %2.2f Hz, hg peak: %2.2f Hz ',...
                       near_lg_ppc_pk, near_hg_ppc_pk);
                    plot(od.fsi_res.near_p1_spec{iC}.freqs, od.fsi_res.near_p1_spec{iC}.subsampled_ppc, 'magenta');
                    ...
                    plot(od.fsi_res.near_p2_spec{iC}.freqs, od.fsi_res.near_p2_spec{iC}.subsampled_ppc, 'black');
                   ...
                   % Relevant info as text
                    ...
                    text(0, 0.92, sts_near_text, 'Color', 'blue', 'FontSize', 9);
                    text(0, 0.84, sts_text{2}, 'Color', 'red', 'FontSize', 9);
                    text(0, 0.76, sts_lfr_text, 'Color', 'red', 'FontSize', 9);
                    text(0, 0.68, sts_lfr_text2, 'Color', 'red', 'FontSize', 9);
                    text(0, 0.6, sts_text{3}, 'Color', 'green', 'FontSize', 9);
                    text(0, 0.52, sts_hfr_text, 'Color', 'green', 'FontSize', 9);
                    text(0, 0.44, sts_hfr_text2, 'Color', 'green', 'FontSize', 9);
                    text(0, 0.32, sts_text{5}, 'Color', 'magenta', 'FontSize', 9);
                    text(0, 0.24, sts_p1_text, 'Color', 'magenta', 'FontSize', 9);
                    text(0, 0.18, sts_p1_text2, 'Color', 'magenta', 'FontSize', 9);
                    text(0, 0.1, sts_text{6}, 'Color', 'black', 'FontSize', 9);
                    text(0, 0.02, sts_p2_text, 'Color', 'black', 'FontSize', 9);
                    text(0, -0.06, sts_p2_text2, 'Color', 'black', 'FontSize', 9);
                    axis off;
                    ...
                    text(0, 0.92, ppc_near_text, 'Color', 'blue', 'FontSize', 9);
                    text(0, 0.84, ppc_text{2}, 'Color', 'red', 'FontSize', 9);
                    text(0, 0.76, ppc_lfr_text, 'Color', 'red', 'FontSize', 9);
                    text(0, 0.68, ppc_lfr_text2, 'Color', 'red', 'FontSize', 9);
                    text(0, 0.6, ppc_text{3}, 'Color', 'green', 'FontSize', 9);
                    text(0, 0.52, ppc_hfr_text, 'Color', 'green', 'FontSize', 9);
                    text(0, 0.44, ppc_hfr_text2, 'Color', 'green', 'FontSize', 9);
                    text(0, 0.32, ppc_text{5}, 'Color', 'magenta', 'FontSize', 9);
                    text(0, 0.24, ppc_p1_text, 'Color', 'magenta', 'FontSize', 9);
                    text(0, 0.18, ppc_p1_text2, 'Color', 'magenta', 'FontSize', 9);
                    text(0, 0.1, ppc_text{6}, 'Color', 'black', 'FontSize', 9);
                    text(0, 0.02, ppc_p2_text, 'Color', 'black', 'FontSize', 9);
                    text(0, -0.06, ppc_p2_text2, 'Color', 'black', 'FontSize', 9);
                    axis off;
