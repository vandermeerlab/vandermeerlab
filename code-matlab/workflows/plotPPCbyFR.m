...
cd('D:\RandomVstrAnalysis\temp2');
rats = {'R117','R119','R131','R132'};

msn_summary = table("label","too_few_spikes","spike_count","nan_in_sts","nan_in_ppc");
fsi_summary = table("label","too_few_spikes","spike_count","nan_in_sts","nan_in_ppc", "subsampled");
    ...
    for jdx = 1:length(ofiles)
        ...
        for iC = 1:length(fsi_labels)
            ...
            if od.fsi_res.near_spec{iC}.flag_tooFewSpikes
                this_row = {fsi_labels{iC},od.fsi_res.near_spec{iC}.flag_tooFewSpikes,nan,nan,nan,nan};
            elseif od.fsi_res.near_spec{iC}.flag_nanppc
                ...
                this_row = {fsi_labels{iC},od.fsi_res.near_spec{iC}.flag_tooFewSpikes,od.fsi_res.near_spec{iC}.spk_count, ...
                    ...
                    od.fsi_res.near_spec{iC}.subsampled_flag};
            end
...
%         do msn stuff
        for iC = 1:length(msn_labels)
            ...
            if od.msn_res.near_spec{iC}.flag_tooFewSpikes
                this_row = {msn_labels{iC},od.msn_res.near_spec{iC}.flag_tooFewSpikes,nan,nan,nan};
            else
