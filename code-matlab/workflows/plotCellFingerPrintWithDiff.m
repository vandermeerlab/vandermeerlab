...
scatter((msn_summary.hfr_mean(clean_msn) - msn_summary.lfr_mean(clean_msn)), (msn_summary.hfr_ppc_peak(clean_msn) - msn_summary.lfr_ppc_peak(clean_msn)));
hold on
...
scatter((fsi_summary.hfr_mean(clean_fsi) - fsi_summary.lfr_mean(clean_fsi)), (fsi_summary.hfr_ppc_peak(clean_fsi) - fsi_summary.lfr_ppc_peak(clean_fsi)));