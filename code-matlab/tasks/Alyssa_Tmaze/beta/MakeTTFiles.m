...
%MAKETTFILES Write .tt files for each tetrode 
%   A .tt file contains all the spikes recorded on a single tetrode. Such 
...
%   spike sorted units combined. .tt files can be loaded with LoadSpikes().
%
%   MAKETTFILES(cfg)
%
%   CONFIG OPTIONS
%     cfg.fc = {}; cell array containing full file names; this is the
%          output from FindFiles. If empty, MakeTFiles will search for 
%          all .ntt files.
