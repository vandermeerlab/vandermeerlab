%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%                                                                     %%%
%%%           Plot Tmaze trials beside tuning curves                    %%%
%%%                                                                     %%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
cfg.output_fn = 'TrialRasterTC'; % it saves as a .png
...
cfg.VertLoc = 1.1; % vertical location 
...
LoadMetadata % loads metadata for trial intervals
...
mr1.lfp = csc;
mr1.lfpHeight = 10;
mr1.evt = metadata.taskvars.trial_iv_R;
mr1.ivColor = 'k';
mr1.openNewFig = 0;
mr1.SpikeHeight = 0.5;
mr1.LineWidth = 0.5;
...
txt = 'R042: right trial, water restricted';
    text(cfg.HorzLoc,cfg.VertLoc,txt,'Units','normalized',...
...
% annotate that thing
xSpot = 9.15; ySpot = 0.75;
text(xSpot,ySpot,'1 s','FontSize',cfg.FontSize)
box off
axis off
...
mr1.lfpHeight = 10;
mr1.lfpMax = 6;
mr1.evt = metadata.taskvars.trial_iv_L;
mr1.ivColor = 'k';
mr1.openNewFig = 0;
mr1.SpikeHeight = 0.5;
mr1.LineWidth = 0.5;
...
txt = 'R050: left trial, food restricted';
    text(cfg.HorzLoc,cfg.VertLoc,txt,'Units','normalized',...
        'VerticalAlignment','bottom',...
        'HorizontalAlignment','left',...
        'FontSize',cfg.FontSize)
...
cfg_temp = [];
cfg_temp.fc = {'R064-2015-04-23-CSC09a.ncs'};
csc = LoadCSC(cfg_temp);
...
txt = 'R064: right trial, water restricted';
    text(cfg.HorzLoc,cfg.VertLoc,txt,'Units','normalized',...
        'VerticalAlignment','bottom',...
        'HorizontalAlignment','left',...
        'FontSize',cfg.FontSize)
