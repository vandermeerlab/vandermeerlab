...
figure; plot(getd(pos,'x'),getd(pos,'y'),'.','Color',[0.7 0.7 0.7],'MarkerSize',4); set(gca,'YDir','reverse'); view(270,90); hold on;
...
if ~isfield(ExpKeys,'convFact')
    convFact = PosCon(pos,ExpKeys.realTrackDims,'YDir','reverse','rot',270);
else 
